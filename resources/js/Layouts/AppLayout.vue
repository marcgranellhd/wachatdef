<template>
    <div class="min-h-screen bg-gray-100">
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <NavLink :href="route('bots.index')" :active="route().current('bots.*')">
                                Bots
                            </NavLink>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <ResponsiveNavLink :href="route('bots.index')" :active="route().current('bots.*')">
                        Bots
                    </ResponsiveNavLink>
        ...
        <!-- Flash Messages -->
        <div v-if="$page.props.flash.success" class="fixed bottom-4 right-4 bg-green-500 text-white p-4 rounded-lg shadow-lg z-50">
            {{ $page.props.flash.success }}
        </div>
        <div v-if="$page.props.flash.error" class="fixed bottom-4 right-4 bg-red-500 text-white p-4 rounded-lg shadow-lg z-50">
